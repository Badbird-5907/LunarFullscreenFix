...
//		the only part that matters
	...
	public static String getPathToLC() {
		if (OS.isWindows()) return System.getenv("APPDATA") + "/.minecraft/optionsLC.txt";
		else if (OS.isMac()) return System.getProperty("user.home") + "/Library/Application Support/.minecraft/optionsLC.txt";
		else if (OS.isUnix()) return System.getProperty("user.home") + "/.minecraft/optionsLC.txt";
		return "none";
	}
